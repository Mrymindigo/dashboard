            ...
            {menu.items.map((nav) => (
              <NavLink
                ...
                className={({ isActive }) =>
                  clsx(
                    isActive
                      ? "relative before:absolute before:w-1 before:h-full before: rounded-l-full before:bg-teal-600 before:-right-6 *:[svg]:text-teal-600! before:border-none bg-zinc-100/60"
                      : "border-transparent!"
                  )
                }
              >
